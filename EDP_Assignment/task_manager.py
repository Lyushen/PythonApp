class Task:
    def __init__(self,title:str,details:str='',alarm_target_time=None,completed:bool=False) -> None:
        """Task class created to represent a task element with certain attributes.
...
class Task_Manager:
    """General Task Manager intended to store a list of Tasks, history and flag to identify changes"""
    ...
    def add_dummies(self):
        """Debug function to quickly fill the list"""
        for i in range(1,21):
    ...
    def add_element(self, title:str, details:str='', alarm_target_time=None,completed:bool=False):
        """The function adds tasks to the end of the list.
    ...
    def complete_element(self, indexes):
        ...
        Args:
            indexes (int): positions to mark tasks done.        """
    ...
    def undo(self):
        """Function to repeat history actions. Just in case we prevent working with no elements in the list"""
        if not self.history:
            return
